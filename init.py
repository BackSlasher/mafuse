...
parser.add_argument('afusetab',nargs='?',default=None,help='Location of the afusetab file to parse')
...
for root in doc:
    ...
    callarr = ['afuse','-o',mounttemplate,'-o',unmounttemplate,'-o',poproottemplate,realroot]
